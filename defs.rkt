...
(define ocilib (ffi-lib "libocilib.dylib"))
...
(def-ocilib prepare OCI_Prepare : (stmt_ptr : _pointer) (sql : _string) -> (result : _bool))
(def-ocilib execute OCI_Execute : (stmt_ptr : _pointer) -> (result : _bool))
(def-ocilib executestmt OCI_ExecuteStmt : (stmt_ptr : _pointer) (sql : _string) -> (result : _bool)) ; does both of prepare and execute sequentially
...
(def-ocilib getint OCI_GetInt : (resultset_ptr : _pointer) (index : _uint) -> (val : _int))
(def-ocilib getint2 OCI_GetInt2 : (resultset_ptr : _pointer) (colname : _string) -> (val : _int))
(def-ocilib getstring OCI_GetString : (resultset_ptr : _pointer) (index : _uint) -> (val : _string))
(def-ocilib getstring2 OCI_GetString2 : (resultset_ptr : _pointer) (colname : _string) -> (val : _string))
...
(def-ocilib bindint OCI_BindInt	: (stmt_ptr : _pointer) (name : _string) (data : (_ptr i _int)) -> (result : _bool))
...
(def-ocilib getdate OCI_DateGetDate : (date_ptr : _pointer) (year : (_ptr o _int)) (month : (_ptr o _int)) (day : (_ptr o _int)) -> (result : _bool) -> (values year month day result))
(def-ocilib setdate OCI_DateSetDate : (date_ptr : _pointer) (year : _int) (month : _int) (day : _int) -> (result : _bool))
(def-ocilib getdatetime OCI_DateGetDateTime : (date_ptr : _pointer) (year : (_ptr o _int)) (month : (_ptr o _int)) (day : (_ptr o _int)) (hour : (_ptr o _int)) (min : (_ptr o _int)) (sec : (_ptr o _int)) -> (result : _bool) -> (values year month day hour min sec result))
(def-ocilib setdatetime OCI_DateSetDateTime : (date_ptr : _pointer) (year : _int) (month : _int) (day : _int) (hour : _int) (min : _int) (sec : _int) -> (result : _bool))
...
(def-ocilib timestamptotext OCI_TimestampToText : (ts_ptr fmt len precision) :: (ts_ptr : _pointer) (fmt : _string) (size : _int = len) (buffer : _bytes = (make-bytes len)) (precision : _int) -> (result : _bool) -> (values (bytes->string/utf-8 (scheme_make_byte_string buffer)) result))